    ...
    return (
        <div class="instructions">
            ...
            <div class="main">
                ...
                <p class="instp">Finally, go to the created theme's repository on your local machine, and replace the <tspan class="inlinecode">.json</tspan> file inside of the directory labelled <tspan class="inlinecode">themes/</tspan> with the <tspan class="inlinecode">.json</tspan> file you downloaded from this website.</p>
                ...
                <p class="instp">If you enjoyed this, please consider <a class="link" target="_blank" rel="noreferrer" href="https://paypal.me/zachariahderrick">supporting this website!</a> It takes time and money to create websites, and I would appreciate any support! It can even be as small as just buying me a coffee! Thank you :)</p>
            </div>
        </div>
    )
}
